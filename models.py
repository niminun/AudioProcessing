...
class ResNetDiscriminator(ResNet):
    """
    A modification of ResNet to work with GreyScale inputs (or any other single channeled image).
    Sizes are smaller than the original ResNet, since we are working with much smaller inputs. TODO - choose sizes
    """
